...
public class AirBus extends Enemy {
    public static final String IMAGE_URL = "file:img/Retina/towerDefense_tile271.png";
    public static final String IMAGE_SHADOW = "file:img/Retina/towerDefense_tile294.png";
